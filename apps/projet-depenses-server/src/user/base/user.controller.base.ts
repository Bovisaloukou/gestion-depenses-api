...
export class UserControllerBase {
  ...
  async findTrackedCryptos(
    ...
    const query = plainToClass(TrackedCryptoFindManyArgs, request.query);
    const results = await this.service.findTrackedCryptos(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/trackedCryptos")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async connectTrackedCryptos(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: TrackedCryptoWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      trackedCryptos: {
        connect: body,
  ...
  @common.Patch("/:id/trackedCryptos")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async updateTrackedCryptos(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: TrackedCryptoWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/trackedCryptos")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectTrackedCryptos(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: TrackedCryptoWhereUniqueInput[]
  ): Promise<void> {
    const data = {
